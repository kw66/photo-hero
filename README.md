...
<p align="center">
  🖼️ 用照片、简笔画或祈愿生成装备的爬塔 RPG 小游戏
</p>

<p align="center">
  📸 拍下一个小物、亲手画出一个道具，或者向祈愿星许愿。<br>
  ⚔️ AI 大模型负责鉴定图像，祈愿则直接生成装备。
</p>
...
《图片勇者》是一款 H5 爬塔 RPG。玩家可以在 **照片勇者**、**画图勇者** 和 **祈愿勇者** 三种模式之间随时切换，把现实小物、手绘简笔画或一次祈愿变成装备，带着它们挑战 40 层魔塔。
...
| ⭐ 祈愿勇者 | 消耗祈愿星直接生成名称、属性和词条随机的装备，无需配置鉴定台 |
...
| 开局资源 | 先领取三张胶卷、画布或祈愿星，全部选中后进入塔内 |
| 生成装备 | 点击空装备格拍照、画图或祈愿；照片和画作需交给鉴定台 |
