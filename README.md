...
《图片勇者》是一款纯前端 H5 爬塔 RPG。玩家可以在 **照片勇者** 和 **画图勇者** 两种模式之间随时切换，把现实小物或手绘简笔画鉴定成装备，再带着这些装备挑战 40 层魔塔。

本仓库是 GitHub Pages 使用的纯静态发布包：打开页面后，游戏逻辑、存档、装备结算和战斗都在浏览器内完成。
...
| 🧬 装备词条 | 史诗和传说装备可能获得特殊词条，部分词条会在战斗中显示计数和加成 |
...
| `index.html` | 页面入口 |
| `styles.css` | 游戏界面样式 |
| `app.js` | 游戏逻辑、鉴定、战斗、存档和音频 |
| `assets/audio/` | 音效 |
| `assets/music/` | BGM |
| `assets/heroes/` | 勇者形态图片 |
| `assets/monsters/` | 怪物静态图片 |
| `assets/monster-animations/` | 怪物动画帧 |
| `assets/npcs/` | NPC 图片 |
| `assets/rewards/` | 奖励图标 |
| `assets/tiles/` | 地板和墙体纹理 |
| `assets/effects/` | 打击特效 |
| `assets/info/` | 小红书交流群二维码 |
...
| 公共鉴定 | 默认体验模式走远端公共鉴定台 |
| 自定义 API | 玩家可在浏览器中填写自己的 OpenAI-compatible 图文模型接口 |
